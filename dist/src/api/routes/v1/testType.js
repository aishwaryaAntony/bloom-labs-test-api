...
var _testType = require('../../../controllers/testType');
 ...
 */
router.get('/', _testType2.default.fetch_all_test_type);
 ...
 */
router.get('/:id', _testType2.default.fetch_test_type_by_id);
 ...
 */
router.post('/', _testType2.default.create_new_test_type);
 ...
 */
router.put('/:id', _testType2.default.update_test_type);
