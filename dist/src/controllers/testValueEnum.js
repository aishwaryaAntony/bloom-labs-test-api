...
exports.fetch_all_test_value_enum = async (req, res, next) => {
    try {
        let fetchAllTestValueEnum = await _models2.default.TestValueEnum.findAll({});
...
exports.fetch_test_value_enum_by_id = async (req, res, next) => {
    try {
        ...
        let findTestValueEnum = await _models2.default.TestValueEnum.findOne({
            where: {
                id: id
            }
        });
...
exports.create_new_test_value_enum = async (req, res, next) => {
    try {
        ...
        let newTestValueEnum = await _models2.default.TestValueEnum.create({
            test_value_type_id,
            value,
            status
        });
...
exports.update_test_value_enum = async (req, res, next) => {
    try {
        ...
        let updatedTestValueEnum = await _models2.default.TestValueEnum.findOne({
            where: {
                id: findTestValueEnum.id
            }
        });
