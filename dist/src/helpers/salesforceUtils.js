...
let conn = new jsforce.Connection({
    loginUrl: _constants.SALESFORCE_LOGIN_URL,
    clientId: _constants.SALESFORCE_CLIENT_ID,
    clientSecret: _constants.SALESFORCE_CLIENT_SECRET
});
...
module.exports = {
    ...
    loginSalesforce: () => {
        return new Promise(async (resolve, reject) => {
            try {
                let auth = await conn.login(_constants.SALESFORCE_USER_EMAIL, _constants.SALESFORCE_SECURITY_PASSWORD);
                resolve(auth);
            } catch (error) {
