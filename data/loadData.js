					...
					if (row === lastRow) {
						if (!isRejected === true) {
							for (let testType of testTypeArray) {
								...
								let testCategory = await db.TestCategory.findOne({
									where: {
