...
exports.fetch_all_physician = async (req, res, next) => {
    try {
        let fetchAllPhysician = await db.Physician.findAll({});
...
exports.fetch_physician_by_id = async (req, res, next) => {
    try {
        ...
        let findPhysician = await db.Physician.findOne({
            where: {
                id: id
            }
        });
...
exports.create_new_physician = async (req, res, next) => {
    try {
        ...
        let new_physician = await db.Physician.create({
            lab_code, 
            name, 
            npi_number, 
            location_ref,
...
exports.update_physician = async (req, res, next) => {
    try {
        ...
        let updatedPhysician = await db.Physician.findOne({
            where: {
                id: id
            }
        });
